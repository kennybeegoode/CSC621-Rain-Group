...
// (3) Finally, output the resultant image in a third raw image (as of this moment, it's
//     just a copy of the input1 image.)
...
int main(int argc, char* argv[])
{
  ...
  itk::MetaImageIO::Pointer metaImageIO1 = itk::MetaImageIO::New();
  itk::MetaImageIO::Pointer metaImageIO2 = itk::MetaImageIO::New();
  ...
  reader1->SetImageIO(metaImageIO1);
  reader1->SetFileName(argv[1]);
  reader1->SetUseStreaming(true);
  metaImageIO1->SetUseStreamedReading(true);

  // reader for input 2
  ReaderType::Pointer reader2 = ReaderType::New();
  reader2->SetImageIO(metaImageIO2);
  reader2->SetFileName(argv[2]);
  reader2->SetUseStreaming(true);
  metaImageIO2->SetUseStreamedReading(true);
